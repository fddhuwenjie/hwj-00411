...
const Square: React.FC<SquareProps> = ({ row, col, isLight, isSelected, isValidMove, isCheck, onClick }) => {
...
export const ChessBoard: React.FC = () => {
  const { board, selectedPiece, validMoves, checkKingPosition, selectPiece, movePiece, currentTurn, gameStatus } = useGameStore();
